cmd_scripts/kconfig/conf.o := gcc -Wp,-MD,scripts/kconfig/.conf.o.d -Iscripts/kconfig -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer -std=gnu89 -pipe -DCURSES_LOC="<curses.h>" -DLOCALE -c -o scripts/kconfig/conf.o ../scripts/kconfig/conf.c
